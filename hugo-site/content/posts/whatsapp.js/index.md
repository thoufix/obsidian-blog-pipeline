...
- **GitHub Pages**  
  ðŸ”— [thoufix.github.io/menu](https://thoufix.github.io/menu)  
  Hosts a static HTML menu table

- ðŸŒ **HTTP Request (axios)**  
  â†“

- **Raspberry Pi 5** (ðŸ“ pilab.local)
  - Runs a Node.js script: `bot.js`
  - Uses:
    - `whatsapp-web.js` â†’ WhatsApp automation
    - `cheerio` â†’ HTML parser
    - `cron` â†’ Schedules messages (breakfast, lunch, dinner)

- ðŸ“¤ **Sends Formatted WhatsApp Messages**  
  â†“
...
- âœ… **Message Delivered to Recipients**
  - me (self)
  - Family (wife, others)
...
## ðŸ“¦ Folder Structure on Raspberry Pi
